  ...
  <b-nav vertical class="nav-left">
    ...
    <b-nav-item> 
      ...
      <b-collapse id="collapse-a" class="mb-2" :visible = "true">
        <b-nav-item exact to = "/q-entity/by-person" exact-active-class="active" 
          v-b-tooltip.hover.right  :title="$t('navbarLeft.entityQueryByPersonIntro')" disabled>
          {{$t('navbarLeft.entityQueryByPerson')}}
        </b-nav-item>
        <b-nav-item exact to = "/q-entity/by-entry" exact-active-class="active" 
          v-b-tooltip.hover.right  :title="$t('navbarLeft.entityQueryByEntryIntro')">
          {{$t('navbarLeft.entityQueryByEntry')}}
        </b-nav-item>
        <b-nav-item exact to = "/q-entity/by-office" exact-active-class="active" 
        v-b-tooltip.hover.right  :title="$t('navbarLeft.entityQueryByOfficeIntro')">
    ...
    <b-nav-item> 
      ...
      <b-collapse id="collapse-b" class="mb-2" :visible = "true">
        <b-nav-item exact to = "/q-relation/by-place" exact-active-class="active" 
          v-b-tooltip.hover.right  :title="$t('navbarLeft.entityQueryByPlace')" disabled>
          {{$t('navbarLeft.entityQueryByPlace')}}
        </b-nav-item>
      <b-nav-item exact to = "/q-relation/two-person" exact-active-class="active" 
        v-b-tooltip.hover.right  :title="$t('navbarLeft.relationQueryTwoPerson')" disabled>
        {{$t('navbarLeft.relationQueryTwoPerson')}}
      </b-nav-item>
      <b-nav-item exact to = "/q-relation/kinship" exact-active-class="active" 
        v-b-tooltip.hover.right  :title="$t('navbarLeft.relationQueryByKinship')">
          {{$t('navbarLeft.relationQueryByKinship')}}
        </b-nav-item>
        <b-nav-item exact to = "/q-relation/association" exact-active-class="active" 
          v-b-tooltip.hover.right  :title="$t('navbarLeft.relationQueryByAssociation')">
