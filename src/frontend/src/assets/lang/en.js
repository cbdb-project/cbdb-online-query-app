...
module.exports = {
    ...
    selectPerson:{
        ...
        browseText:"Browse",
        browserNotSupportFileReader:"Sorry, this component cannot work on your browser. You can select people from database instead,' but we strongly recommend you to change a browser",
        cannotParse:"Sorry, we cannot parse the file you upload. Please check whether the data format is correct.",
        warning:"Please upload the .json file generated by this application, otherwise we cannot parse."
    },
    selectEntry:{
