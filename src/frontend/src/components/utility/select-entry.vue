      ...
      <b-row>
        <b-col :cols="4" style="text-align:right">
          <b-card>
            <b-form-group
              label-cols="4"
              label="Entry Name"
              label-for="select-entry-input-en-name"
            >
              <b-form-input
                id="select-entry-input-name"
            ...
            <b-form-group>
              <b-button
                variant="primary"
                :disabled="isBusy || formData.eName === ''"
                @click="find"
              >
        ...
        <b-col :cols="8">
          <b-form-group style="text-align:right">
            ...
            <b-button-group>
              <b-button
                v-if="this.selectedEntry.length > 0"
                @click="clearSelected"
              ...
              >
              <b-button
                v-if="!(this.items.length === this.selectedEntry.length)"
                @click="selectAllRows"
                variant="outline-secondary"
                size="sm"
...
export default {
  ...
  methods: {
    ...
    find() {
      getListByName(
        "entry_list_by_name",
        [this.formData.eName, this.formData.accurate],
        this
      );
    }
  },
