            ...
            <b-col cols="8" style="text-align:left">
              ...
              <b-card>
                <b-row class="pl-3" style="text-align:center">
                  <b-col>
                    <span
                      v-if="this.officeTable.length == 0"
                      style="line-height:31px"
                      >**{{ $t("globalTerm.all") }}**</span
                    >
                    <span v-else
                      >{{ officeTable[0].pNameChn }}
                      <span v-if="this.officeTable.length > 1"
                        >及另外{{ officeTable.length - 1 }}個官職</span
                      >
                    </span>
                    <view-selected
                      name="office"
                      :fields="this.officeField"
                      :items="this.officeTable"
                      @update:items="val => (this.officeTable = val)"
                    ></view-selected>
                  </b-col>
                </b-row>
              </b-card>
        ...
        <div class="card-item-body px-3">
          ...
          <b-row class="px-3 mb-3">
            <b-card-text class="card-item-title mt-3">
              <b-form-checkbox
                ...
                size="lg"
                id="checkbox-0"
                v-model="formData.useOfficePlace"
                name="checkbox-0"
                value="1"
                unchecked-value="0"
              >
          ...
          <b-row class="py-3 my-3" v-if="formData.useOfficePlace === '1'">
            <b-col cols="8" style="text-align:left">
              <b-card>
                <b-row class="pl-3" style="text-align:center">
                  <b-col>
                    <span
                      v-if="this.officePlaceTable.length == 0"
                      style="line-height:31px"
                      >**{{ $t("globalTerm.all") }}**</span
                    >
                    <span v-else
                      >{{ officePlaceTable[0]["pNameChn"] }}
                      <span v-if="this.officePlaceTable.length > 1"
                        >及另外{{ officePlaceTable.length - 1 }}個地點</span
                      >
                    </span>
                    <view-selected
                      name="officePlace"
                      :fields="this.officePlaceField"
                      :items="this.officePlaceTable"
                      @update:items="val => (this.officePlaceTable = val)"
                    ></view-selected>
                  </b-col>
                </b-row>
              </b-card>
            ...
            <b-col cols="4" style="text-align:left">
              <b-button-group>
                <select-place
                  @getPlaceName="handleGetOfficePlace"
                  name="office"
...
export default {
  ...
  computed: {
    ...
    isInvalid() {
      return (
        this.getOfficeTableId.length == 0 ||
