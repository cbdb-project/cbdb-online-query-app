  ...
  <div class="wrapper">
    ...
    >
      <b-card header-tag="header" footer-tag="footer">
        ...
        <div>
          <h6 class="m-3">
            [{{ personInfo.BasicInfo.PersonId }}]
            {{ personInfo.BasicInfo.ChName }} {{ personInfo.BasicInfo.EngName }}
          </h6>
          <b-tabs content-class="mt-3">
            ...
            >
              <b-card>
                ...
                <b-row class="px-3 mb-3">
                  <b-col>
                    {{ $t("globalTerm.notes") }}:
                    <p>{{ personInfo.BasicInfo.Notes }}</p>
                  </b-col>
                </b-row>
              </b-card>
            </b-tab>
            ...
            >
              <div
                v-if="
                  personInfo.PersonAliases.Alias !== '' &&
                    personInfo.PersonAliases.Alias instanceof Array
                "
              >
                <b-card
                  v-for="(altName, index) in personInfo.PersonAliases.Alias"
                  :key="index"
                >
                  <!-- 第一行：別名 拼音-->
                  <b-row class="px-3 mb-3">
                  ...
                  <b-row class="px-3 mb-3">
                    <b-col>
                      ...
                      {{ altName.AliasType
                      }}<span v-if="altName.nType"> {{ altName.nType }}</span>
                    </b-col>
                  </b-row>
                  <!--
              ...
              >
                <b-card>
                  ...
                  <b-row class="px-3 mb-3">
                    <b-col>
                      <b>
                        {{ personInfo.PersonAliases.Alias.AliasName
                        }}<span v-if="isValidVar('')"
                          >（{{ altName.name }}）</span
                        ></b
                      >
                  ...
                  <b-row class="px-3 mb-3">
                    <b-col>
                      {{ $t("entityQueryByPerson.result.altNameType") }}:
                      {{ personInfo.PersonAliases.Alias.AliasType
                      }}<span v-if="''"> {{ altName.nType }}</span>
                    </b-col>
                  </b-row>
                  <!--
                  <show-source :sNameChn="personInfo.PersonSources.Source.Source" 
              ...
              <b-card>
                ...
                <b-row class="px-3 mb-3">
                  <b-col cols="6">
                    <show-year
                      ...
                      id="0"
                      :range="'0'"
                      :year="personInfo.BasicInfo.YearBirth"
                      :nhChn="
                        personInfo.BasicInfo.DynastyBirth +
                          personInfo.BasicInfo.EraBirth
                      "
                      :nh="''"
                      :nhCount="personInfo.BasicInfo.EraYearBirth"
                      :month="''"
                      :isIntc="''"
                      :day="''"
                      :gz="''"
                  ...
                  <b-col cols="6">
                    <show-year
                      ...
                      id="0"
                      :range="''"
                      :year="personInfo.BasicInfo.YearDeath"
                      :nhChn="
                        personInfo.BasicInfo.DynastyDeath +
                          personInfo.BasicInfo.EraDeath
                      "
                      :nh="''"
                      :nhCount="personInfo.BasicInfo.EraYearDeath"
                      :month="''"
                      :isIntc="''"
                      :day="''"
                      :gz="''"
                ...
                <b-row class="px-3 mb-3">
                  <b-col cols="6">
                    ...
                    {{ personInfo.BasicInfo.YearsLived }}
                    <span v-if="isValidVar('')"
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      this.axios
        .get(
          "https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=" +
