      ...
      <b-card header-tag="header" footer-tag="footer">
        ...
        <div class="card-item-body px-3">
          ...
          <b-row class="mb-3 pb-3">
            <b-col cols="3">
              <label for="max-loop" class="user-input-label"
                >{{ $t("relationQueryByKinship.maxLoop") }}:
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
              </label>
              <b-form-input
                id="max-loop"
                v-model="formData.MLoop"
                placeholder=""
                :state="maxLoopValidation(formData.MLoop)"
                :disabled="false"
              ></b-form-input>
          ...
          <b-row class="px-3 mb-3" v-if="formData.kinshipType === 0">
            <b-col>
              ...
              <b-form-input
                ...
                placeholder=""
                :state="maxLoopValidation(formData.MAncGen)"
                :disabled="false"
              ></b-form-input>
              <b-form-invalid-feedback
                :state="maxLoopValidation(formData.MAncGen)"
            ...
            <b-col>
              ...
              <b-form-input
                ...
                placeholder=""
                :state="maxLoopValidation(formData.MDecGen)"
                :disabled="false"
              ></b-form-input>
              <b-form-invalid-feedback
                :state="maxLoopValidation(formData.MDecGen)"
            ...
            <b-col>
              ...
              <b-form-input
                ...
                placeholder=""
                :state="maxLoopValidation(formData.MColLink)"
                :disabled="false"
              ></b-form-input>
              <b-form-invalid-feedback
                :state="maxLoopValidation(formData.MColLink)"
            ...
            <b-col>
              ...
              <b-form-input
                ...
                placeholder=""
                :state="maxLoopValidation(formData.MMarLink)"
                :disabled="false"
              ></b-form-input>
              <b-form-invalid-feedback
                :state="maxLoopValidation(formData.MMarLink)"
