...
<script>
import {isNull,yearValidation,peoplePlaceGetter} from '@/components/utility/utility-functions.js'
...
export default {
  ...
  computed:{
    ...
    isInvalid(){
      return (this.formData.placeType.length===0)||(this.getPeoplePlaceTableId.length===0)||this.validation('dateEndTime')===false || this.validation('dateStartTime')===false
    },
