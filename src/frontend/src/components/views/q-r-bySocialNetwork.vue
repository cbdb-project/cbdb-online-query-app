  ...
  <div class="hello">
    <b-card header-tag="header" footer-tag="footer">
      ...
      <div class  = "card-item-body px-3">
        ...
        <b-row class = "py-3 mb-3">
          <b-col cols="3" style = "text-align:left">
            <b-card-text class = "card-item-title">Gender</b-card-text>    
      ...
      <div class  = "card-item-body px-3">
        ...
        <b-row class = "px-3 mb-3"  v-if="formData.includeKinship==='1'&&formData.kinship.kinshipType==='custom'">
          <b-col>
