...
<div class = "wrapper">
      ...
      <div class  = "card-item-body px-3">
        ...
        <b-row class = "py-3 mb-3">
          <b-col cols="3" style = "text-align:left">
            <b-card-text class = "card-item-title">{{$t('globalTerm.gen')}}</b-card-text>    
            <b-card-text class = "card-item-title mt-3 ml-3">
              <b-form-checkbox switch size="lg" id="checkbox-2" v-model= "formData.includeMale" name="checkbox-2"
                value = "1" unchecked-value = "0">
                <span style="font-size:16px">{{$t('globalTerm.male')}}</span>
              </b-form-checkbox>  
            </b-card-text> 
            <b-card-text class = "card-item-title mt-3 ml-3">
              <b-form-checkbox switch size="lg" id="checkbox-3" v-model= "formData.includeFemale" name="checkbox-3"
                value = "1" unchecked-value = "0">
                <span style="font-size:16px">{{$t('globalTerm.female')}}</span>
              </b-form-checkbox>  
            </b-card-text> 
          </b-col>
          <b-col cols="6">
      ...
      <div class  = "card-item-body px-3">
        <b-row class = "px-3 mb-3">
          <b-card-text class = "card-item-title mt-3">
            <b-form-checkbox switch size="lg" id="checkbox-4" v-model= "formData.includeKinship" name="checkbox-4"
              value="1" unchecked-value="0">
              <span style="font-size:16px">{{$t('relationQueryBySocialNetwork.includeKinship')}}</span>
            </b-form-checkbox>  
          </b-card-text> 
        </b-row>
        ...
        <b-row class = "px-3 mb-3"  v-if="formData.includeKinship==='1'&&formData.kinship.kinshipType===0">
          <b-col>
        ...
        <b-row class = "px-3 mb-3">
          <b-card-text class = "card-item-title mt-3">
            <b-form-checkbox switch size="lg" id="checkbox-1" v-model= "formData.indexYear" name="checkbox-1"
              ...
              <span style="font-size:16px">{{$t('globalTerm.indexYear')}}</span>
            </b-form-checkbox>  
          </b-card-text> 
        </b-row>
  ...
  <div class="hello" v-if="result!==undefined">
    <b-card header-tag="header" footer-tag="footer">
      ...
      <query-result name="network-result" :items="result.ass" :fields="resultField"></query-result>
    </b-card>
  </div>
</div>
</template>
